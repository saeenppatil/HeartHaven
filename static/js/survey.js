...
function submitForm() {
    ...
    .then(data => {
        console.log('Success:', data);
        window.location.href = `/go-result/prob/${data.probability}/name/${data.Name}/age/${data.Age}/ageLower/${data.AgeGroupLowerBound}/ageHigher/${data.AgeGroupHigherBound}/ageProb/${data.AgeGroupProbability}`;
    })
